...
public class LoginTestAssert2 {
    ...
    public void myLoginTest1()
    {
        ...
        try {
            actual = driver.findElement(By.xpath("//ul[@class='menusubnav']//li[15]/a")).getText();
        }
        catch (Exception e)
        {
        ...
        Assert.assertEquals(actual,expected,"wrong text/ text unavailable");
